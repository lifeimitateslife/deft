...
// This installed-shell acceptance test requires a fresh app profile. Never replace an owner's profile.
try {
  await fs.access(profile);
  throw Error(
    "Default DEFT profile exists; preserve it and use isolated tests instead.",
  );
} catch (error) {
